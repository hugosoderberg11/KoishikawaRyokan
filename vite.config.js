    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          minshukuGuesthouse: resolve(__dirname, 'template/minshuku-guesthouse/index.html'),
          minshukuGuesthouseReserve: resolve(__dirname, 'template/minshuku-guesthouse/reserve/index.html'),
          templeStayShukubo: resolve(__dirname, 'template/temple-stay-shukubo/index.html'),
          templeStayShukuboReserve: resolve(__dirname, 'template/temple-stay-shukubo/reserve/index.html'),
          kaisekiRyokan: resolve(__dirname, 'template/kaiseki-ryokan/index.html'),
          kaisekiRyokanReserve: resolve(__dirname, 'template/kaiseki-ryokan/reserve/index.html'),
