...
function applyI18n() {
  ...
  $('#drawer-site-name') && ($('#drawer-site-name').textContent = siteData.nameEn || 'STELLA FOREST');
  $('#footer-site-name') && ($('#footer-site-name').textContent = `✦ ${siteData.nameEn || 'STELLA FOREST'}`);
