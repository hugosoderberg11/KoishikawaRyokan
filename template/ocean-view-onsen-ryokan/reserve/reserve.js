...
function applyI18n() {
  ...
  $('#drawer-site-name') && ($('#drawer-site-name').textContent = siteData.nameEn || 'OCEANA RESORT');
  $('#footer-site-name') && ($('#footer-site-name').textContent = `◆ ${siteData.nameEn || 'OCEANA RESORT'}`);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form?.addEventListener('submit', (e) => {
    ...
    setTimeout(() => {
      ...
      submitBtn.style.background = 'var(--gold-dark)';
